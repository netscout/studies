...
- [gRPC란?](#grpc란)
- [그냥 한 번 해보자!](#그냥-한-번-해보자)
  - [폴더 생성 및 go 모듈을 초기화](#폴더-생성-및-go-모듈을-초기화)
  - [gRPC 계약(contract) 작성](#grpc-계약contract-작성)
  - [gRPC 코드 생성](#grpc-코드-생성)
  - [서버 코드 작성](#서버-코드-작성)
  - [클라이언트 코드 작성](#클라이언트-코드-작성)
  - [서버와 클라이언트 실행](#서버와-클라이언트-실행)
- [정리](#정리)
