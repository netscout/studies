...
- [Javascript의 간략한 역사](#javascript의-간략한-역사)
- [Temporal로 다시 돌아와서](#temporal로-다시-돌아와서)
- [1. 타임존은 '로컬'과 'UTC' 딱 두 개뿐입니다](#1-타임존은-로컬과-utc-딱-두-개뿐입니다)
  - [Temporal은 날짜에 타임존을 결합할 수 있습니다](#temporal은-날짜에-타임존을-결합할-수-있습니다)
- [2. 파서(parser)를 신뢰할 수 없습니다](#2-파서parser를-신뢰할-수-없습니다)
  - [Temporal은 명확한 규칙을 요구합니다](#temporal은-명확한-규칙을-요구합니다)
- [3. Date는 변경 가능(mutable)합니다](#3-date는-변경-가능mutable합니다)
  - [Temporal의 날짜는 불변(immutable) 합니다](#temporal의-날짜는-불변immutable-합니다)
- [4. 서머타임(DST) 동작을 예측할 수 없습니다](#4-서머타임dst-동작을-예측할-수-없습니다)
  - [Temporal은 서머타임이 정확하게 적용됩니다!](#temporal은-서머타임이-정확하게-적용됩니다)
- [5. 계산 API가 조악합니다](#5-계산-api가-조악합니다)
  - [Temporal은 오해 없이 정확한 API를 제공합니다.](#temporal은-오해-없이-정확한-api를-제공합니다)
- [6. 그레고리력 외의 달력을 지원하지 않습니다](#6-그레고리력-외의-달력을-지원하지-않습니다)
  - [Temporal은 제대로 지원합니다.](#temporal은-제대로-지원합니다)
- [Temporal의 현재](#temporal의-현재)
- [Typescript의 지원](#typescript의-지원)
- [마치면서](#마치면서)
- [참고자료](#참고자료)
