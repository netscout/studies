...
- [Go 환경설정](#go-환경설정)
  - [1. 래퍼 프로그램 설치](#1-래퍼-프로그램-설치)
  - [2. `~/go/bin` 을 PATH에 설정하기](#2-gobin-을-path에-설정하기)
  - [3. 실제 SDK 다운로드](#3-실제-sdk-다운로드)
  - [4. 버전 확인하기](#4-버전-확인하기)
  - [5. SIMD 지원 확인하기](#5-simd-지원-확인하기)
  - [6. 설정 삭제하기](#6-설정-삭제하기)
- [테스트용 코드 작성하기](#테스트용-코드-작성하기)
  - [1. 폴더와 모듈 생성](#1-폴더와-모듈-생성)
  - [2. 테스트에 사용할 2개의 연산 커널](#2-테스트에-사용할-2개의-연산-커널)
    - [2-1. 합 구하기](#2-1-합-구하기)
    - [2-2. 삼차 다항식 계산](#2-2-삼차-다항식-계산)
  - [3. 커널 구현하기(kernels.go)](#3-커널-구현하기kernelsgo)
  - [4. SIMD 커널 구현하기(kernel_simd.go)](#4-simd-커널-구현하기kernel_simdgo)
    - [4-1. SumSIMDSingle 함수](#4-1-sumsimdsingle-함수)
    - [4-2. SumSIMDUnrolled4 함수](#4-2-sumsimdunrolled4-함수)
    - [4-3. SumSIMDUnrolled8 함수](#4-3-sumsimdunrolled8-함수)
    - [4-4. PolySIMD 함수](#4-4-polysimd-함수)
  - [5. 대체 커널 구현하기(kernel_stub.go)](#5-대체-커널-구현하기kernel_stubgo)
  - [6. 테스트 작성하기(kernel_test.go)](#6-테스트-작성하기kernel_testgo)
- [테스트와 벤치마크 돌려보기](#테스트와-벤치마크-돌려보기)
  - [결과 한 줄 해부하기](#결과-한-줄-해부하기)
  - [10번 재서 통계로 판정하기](#10번-재서-통계로-판정하기)
  - [결과가 말해주는 것](#결과가-말해주는-것)
  - [후속 실험: Poly도 unroll 해보기](#후속-실험-poly도-unroll-해보기)
  - [마지막 실험: core는 다 쓰고 있었을까?](#마지막-실험-core는-다-쓰고-있었을까)
- [마치면서](#마치면서)
- [참고자료](#참고자료)
